...
class CreateSistemaPlanoServicos extends Migration
{
    public function up()
    {
        $this->forge->addField([
            'ID_PLANO_SERVICO' => [
                ...
                'unsigned' => true,
                'auto_increment' => true,
                'comment' => 'Identificador único sequencial do vínculo plano-serviço (PK)',
            ],
            'UUID' => [
                'type' => 'CHAR',
                'constraint' => 36,
        ...
        $this->forge->addKey('ID_PLANO_SERVICO', true);
        $this->forge->addUniqueKey('UUID');
        $this->forge->addUniqueKey(['PLANO_ID', 'SERVICO_ID']);
        ...
        $this->forge->createTable('SIST_PLANO_SERVICOS');
    }

    public function down()
    {
        $this->forge->dropTable('SIST_PLANO_SERVICOS');
    }
}
