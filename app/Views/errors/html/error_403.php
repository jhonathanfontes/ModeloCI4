...
<head>
    ...
    <title>Erro 403 — ModeloBF2</title>
...
<body>
    <div class="error-page">
        <div class="error-card">
            ...
            <div class="error-label">Acesso Negado</div>
            ...
            <?php else : ?>
                <h1>Ops! Ação não permitida.</h1>
                <p>Você não tem permissão para executar esta ação. Isso pode ter ocorrido porque o token de segurança expirou ou a requisição foi considerada inválida.</p>
                ...
                <div class="error-details">
                    Tente recarregar a página e enviar o formulário novamente. Se o problema persistir, entre em contato com o suporte técnico.
                </div>
            <?php endif; ?>
        </div>
    </div>
