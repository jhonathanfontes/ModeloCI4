...
<head>
    ...
    <title>Erro 500 — ModeloBF2</title>
...
<body>
    <div class="error-page">
        <div class="error-card">
            ...
            <div class="error-label">Erro Interno do Servidor</div>
            ...
            <?php else : ?>
                ...
                <p>Ocorreu um erro interno no servidor. Nossa equipe já foi notificada e estamos trabalhando para resolver o mais rápido possível.</p>
